...
const Actiepad = () => {
  return ( 
    <div className="main">
      <Head tag="sub" header="Actiepad" text=""/>
      ...
      <div className="content">
        ...
        <div className="content__wrapper">
          <ContentBlock tag="default" header="Actiepaden verhogen de effectiviteit van een website" text="Goed doordachte actiepaden leiden bezoekers van een website naar een gewenste actie en verhogen daarmee de effectiviteit van een website."/>
