      ...
      <div className="content">
        ...
        <div className="content__wrapper">
          <div className="content__container">
            ...
            <p className="content__text line-height">Website bezoekers worden klanten als de informatie op een website vertrouwen opwekt en tot actie aanzet. Door betrouwbare informatie in de juiste volgorde aan te reiken wordt een pad naar de gewenste actie gelegd. Fivides noemt dat het actiepad. Een Actiepad Analyse van Fivides maakt zichtbaar waar de zwakke plekken in de informatie op de actiepaden van jouw website zitten. Daarmee kun je snel aan de slag om de informatie op jouw actiepaden te verbeteren en meer klanten te krijgen.</p>
          </div>

          <div className="content__container review">
            <p className="content__review__name">R. Dulmers, eigenaar Scholen met Succes</p>
            <p className="content__review line-height">“Zeer informatieve rapportage inclusief power point van Fivides met heldere, consequent doorgevoerde analyse en veel zaken om op strategisch/tactisch niveau over na te denken met het team. Op operationeel vlak veel concrete punten die op korte termijn kunnen worden aangepakt om effectiviteit, aantrekkelijkheid en actiegerichtheid van de website versterken.”</p>
          </div>

          <div className="content__container block">
            <h2 className="content__header">Vertrouwen is cruciaal</h2>
            <p className="content__text line-height">Er is veel wetenschappelijk bewijs dat vertrouwen in een website cruciaal is om gewenst gedrag bij website bezoekers te stimuleren. Daarvoor moet die informatie relevant, consistent, duidelijk en beargumenteerd zijn. </p>
