...
const Analysemodel = () => {
  return ( 
    <div className="main">
      <Head tag="sub" header="Analysemodel" text="Met een Actiepad Analyse van Fivides weet je hoe je van een jouw websitebezoekers klanten kunt maken."/>
      ...
      <div className="content">
        ...
        <div className="content__wrapper">
          <ContentBlock tag="default" header="Vertrouwen is cruciaal" text="Het analysemodel van de Fivides Actiepad Analyse bevat vier eigenschappen van informatie die gezamenlijk het vertrouwen in die informatie opwekken. Dat vertrouwen is cruciaal omdat een websitebezoeker geen actie zal uitvoeren als het vertrouwen in de website ontbreekt."/>
